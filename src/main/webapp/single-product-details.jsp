...
<body>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            <span>áo sơ mi</span>
            <a href="cart.html">
                <h2>ÁO SƠ MI DÀI TAY - AR91008D2</h2>
            </a>
            <p class="product-price"><span class="old-price">498.000 ₫</span> 299.000 ₫</p>
            <p class="product-desc">Chất liệu: 50% Bamboo, 50% Microfiber.<br>
                Áo sơ mi dài tay, kiểu dáng Regular fit thoải mái, không kén người mặc Tone màu trắng nam tính, lịch lãm, thời trang.<Br>
                Chất liệu Bamboo mịn mát từ vải sợi tre thân thiện môi trường.<br></p>
